...
<html>
    ...
    <body>
        <ul>
        	<li>
        	//custom.LoginController<br>
        		<a href="<c:url value='/jsp/login/login'/>">/jsp/login/login.do</a>
        		(viewjsp/loginForm.jsp, &lt;form:* /&gt; 태그 및 &lt;spring:message&gt; 태그 예제) 
         	</li>
         	<br>
        	<li>
        	//RegistMemberController<br>
			...
			<br>    	
			<li>
			//dispatcherInternal-servlet.xml<br>
