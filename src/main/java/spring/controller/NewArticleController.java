...
public class NewArticleController {
	...
	public String submit(@ModelAttribute("command") NewArticleCommand command) {
		...
		// 만약 어노테이션을 붙여주지 않으면 클래스 이름의 첫 글자를 소문자로 만들어서 객체를 만들어서 model에 담아 같은 일을
		// 해주는데
		// 이름이 너무 기니까 (화면창에서 ${dto.n1 이렇게 불러줘야함. 지금 예제는 클래스 이름이
		// 짧네})@ModelAttribute 어노테이션에서 이름을 지정해주도록 하자.
